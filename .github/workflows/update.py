...
def update_golden_boot():
    ...
    csv_df: pl.DataFrame = pl.read_csv(standings_csv_file, truncate_ragged_lines=True)
    standings_df: pl.DataFrame = pl.read_csv(standings_csv_file, truncate_ragged_lines=True).filter(
...
def update_over_under():
    ...
    over_under_df: pl.DataFrame = pl.read_csv(over_under_csv_file, truncate_ragged_lines=True)
